...
public class GunsProperties {
    ...
    public String getFileDownloadPath() {
        //如果没有写文件上传路径,保存到临时目录
        if (ToolUtil.isEmpty(fileDownloadPath)) {
            return getTempPath();
        } else {
            //判断有没有结尾符,没有得加上
    ...
    public String getFileUploadIpAndPort() {
        return fileUploadIpAndPort;
    }

    public void setFileUploadIpAndPort(String fileUploadIpAndPort) {
        this.fileUploadIpAndPort = fileUploadIpAndPort;
    }
}
