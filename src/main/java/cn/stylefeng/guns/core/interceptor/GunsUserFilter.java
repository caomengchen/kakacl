...
public class GunsUserFilter extends AccessControlFilter {
    ...
    private String url = GlobalStr.DOMAIN_URL;
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (httpServletRequest.getHeader("x-requested-with") != null
            ...
            if (referer == null) {
                ...
                //WebUtils.issueRedirect(request, response, url, new HashMap<>(), true, true);
                return false;
            } else {
                ...
                if (ShiroKit.getSession().getAttribute("sessionFlag") == null) {
                    ...
                    //httpServletRequest.getRequestDispatcher(url + "/login").forward(request, response);
