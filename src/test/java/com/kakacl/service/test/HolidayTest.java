...
//        holidayList.add("2018-10-06");
        holidayList.add("2018-12-20");
        Date date = DateUtils.addAndSubtractDaysByGetTime(new Date(), 9);
        System.out.println(sdf.format(date));

        //获取计划激活日期
        Date scheduleActiveDate = HolidayUtils.getScheduleActiveDate(holidayList, new Date() , 10);
